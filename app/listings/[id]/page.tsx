    ...
    <main className="p-6 max-w-3xl mx-auto space-y-4 font-sans">
      ...
      <div className="border p-6 rounded-lg bg-white shadow-sm space-y-4">
        ...
        <div className="flex justify-between border-b pb-4">
          <p className="text-gray-600">{property.suburb} • {property.property_type}</p>
        ...
        <p className="bg-gray-50 p-3 text-sm rounded border">
          Agent: {property.agent_name} ({property.agent_email})
        </p>
        
        {/* Assessment Admin Toggle UI */}
        <label className="flex items-center gap-2 font-bold text-red-600 mt-6 pt-4 border-t cursor-pointer">
          <input 
            type="checkbox" 
            checked={isAdmin} 
        ...
        {isAdmin && property.internal_status_notes && (
          <p className="bg-red-50 text-red-800 p-3 rounded border border-red-200">
